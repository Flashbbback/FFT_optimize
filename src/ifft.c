...
//     // 1. 交换参数调用
//     fft_AVX512_fixedP(imag, real, ctx);

//     // 2. 交换回数据位置
//     int num_vecs = N / 32;
//     __m512i *ptr_real = (__m512i *)real;
//     __m512i *ptr_imag = (__m512i *)imag;

//     for (int i = 0; i < num_vecs; i++)
//     {
//         __m512i temp_imag = ptr_real[i];
//         __m512i temp_real = ptr_imag[i];
        
//         ptr_real[i] = temp_real;
//         ptr_imag[i] = temp_imag;
//     }
// }
